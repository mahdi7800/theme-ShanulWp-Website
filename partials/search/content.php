...
if ($set_index_website) :
    switch($set_index_website):
        case 1:?>
            ...
            <?php get_template_part('partials/layout/start_layout','start_layout');?>
            <?php get_template_part('partials/search/title-search','title_search');?>
            <?php get_template_part('partials/search/content-search','content-search');?>
